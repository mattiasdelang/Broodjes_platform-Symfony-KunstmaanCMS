 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="kuma_broodjesbundle_image_page_parts")
 */
class ImagePagePart extends AbstractPagePart
{
    ...
    {
	return 'KumaBroodjesBundle:PageParts:ImagePagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \Kuma\BroodjesBundle\Form\PageParts\ImagePagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \Kuma\BroodjesBundle\Form\PageParts\ImagePagePartAdminType();
    }
}
