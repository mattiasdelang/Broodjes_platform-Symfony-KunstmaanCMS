 ...
 * HeaderPagePart
 *
 * @ORM\Table(name="kuma_broodjesbundle_header_page_parts")
 * @ORM\Entity
 */
class HeaderPagePart extends AbstractPagePart
{
    ...
    {
	return 'KumaBroodjesBundle:PageParts:HeaderPagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \Kuma\BroodjesBundle\Form\PageParts\HeaderPagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \Kuma\BroodjesBundle\Form\PageParts\HeaderPagePartAdminType();
    }
}
