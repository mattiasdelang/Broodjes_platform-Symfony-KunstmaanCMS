...
namespace Kuma\BroodjesBundle\DataFixtures\ORM\DefaultSiteGenerator;
...
use Kuma\BroodjesBundle\Entity\Pages\ContentPage;
use Kuma\BroodjesBundle\Entity\Pages\HomePage;
